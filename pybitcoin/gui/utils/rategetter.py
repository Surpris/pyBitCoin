...
def get_rate_via_crypto(histoticks, params):
    """get_rate_via_crypto(histoticks, params) -> 
...
def to_dataFrame(data, is_datetime=False):
    """to_dataFrame(data)
...
def to_csv(data, fpath, is_datetime=False):
    """to_csv(data, fpath)
...
if __name__ == "__main__":
    ...
    result = get_rate_via_crypto(histoticks, params)
    print(to_dataFrame(result, False))
